...
import com.lotus.ota.UpdaterApplication;
import com.lotus.ota.activities.UpdaterActivity;
import com.lotus.ota.misc.Constants;
import com.lotus.ota.misc.State;
import com.lotus.ota.misc.UpdateInfo;
import com.lotus.ota.requests.UpdatesJsonObjectRequest;
import com.lotus.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.lotus.ota.action.UPDATE_CHECK_FINISHED";
