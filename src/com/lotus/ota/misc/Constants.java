 ...
 */
package com.lotus.ota.misc;

import android.app.AlarmManager;

public class Constants {
    // Download related
    public static final String UPDATES_FOLDER = "lotus";
    public static final String DOWNLOAD_ID = "download_id";
    public static final String DOWNLOAD_NAME = "download_name";
    public static final String DOWNLOAD_TMP_EXT = ".tmp";
    public static final String DOWNLOAD_CHANNEL_ID = "com.lotus.ota.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "com.lotus.ota.DOWNLOADING_CHANNEL";
    // Preferences
    ...
    // Build vars
    public static final String CURRENT_DEVICE_NAME = "ro.lotus.device";
    public static final String CURRENT_VERSION = "ro.lotus.version";
    public static final String CURRENT_BUILD_TYPE = "ro.lotus.build_type";
    public static final String OTA_URL = "https://raw.githubusercontent.com/LotusOS/OTA/pie/%s";
    // Expressions
